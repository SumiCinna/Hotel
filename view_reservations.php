...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <div class="section">
                <h3><i class="fas fa-calendar-check"></i> All Reservations</h3>
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="10" style="text-align: center; padding: 20px; color: #666;">No reservations found</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
